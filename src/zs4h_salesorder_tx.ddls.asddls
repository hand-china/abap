@AbapCatalog.sqlViewName: 'ZS4H_SO_TX'
...
define view ZS4H_SalesOrder_TX as select from zs4h_so as SalesOrder  -- the sales order table is the data source for this view
