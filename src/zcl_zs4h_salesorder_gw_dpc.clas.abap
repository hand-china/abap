class ZCL_ZS4H_SALESORDER_GW_DPC definition
  public
...
protected section.
  ...
  methods SEPM_I_BUSINESSP_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZS4H_SALESORDER_GW_MPC=>TS_SEPM_I_BUSINESSPARTNERTYPE
    raising
  ...
  methods SEPM_I_BUSINESSP_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZS4H_SALESORDER_GW_MPC=>TT_SEPM_I_BUSINESSPARTNERTYPE
  ...
  methods SEPM_I_SALESOR01_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZS4H_SALESORDER_GW_MPC=>TS_SEPM_I_SALESORDERITEMTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SEPM_I_SALESOR01_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZS4H_SALESORDER_GW_MPC=>TT_SEPM_I_SALESORDERITEMTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SEPM_I_SALESORDE_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZS4H_SALESORDER_GW_MPC=>TS_SEPM_I_SALESORDERTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SEPM_I_SALESORDE_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZS4H_SALESORDER_GW_MPC=>TT_SEPM_I_SALESORDERTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZS4H_SALESORDER_GW_DPC IMPLEMENTATION.
...
*&* This class has been generated on 2018-08-29 17:16:08 in client 700
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZS4H_SALESORDER_GW_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA sepm_i_businessp_create_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_businesspartnertype.
 DATA sepm_i_salesorde_create_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_salesordertype.
 DATA sepm_i_salesor01_create_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_salesorderitemtype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  SEPM_I_SalesOrder
*-------------------------------------------------------------------------*
     WHEN 'SEPM_I_SalesOrder'.
*     Call the entity set generated method
...
*-------------------------------------------------------------------------*
*             EntitySet -  SEPM_I_SalesOrderItem
*-------------------------------------------------------------------------*
     WHEN 'SEPM_I_SalesOrderItem'.
*     Call the entity set generated method
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA sepm_i_businessp_get_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_businesspartnertype.
 DATA sepm_i_salesorde_get_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_salesordertype.
 DATA sepm_i_salesor01_get_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_salesorderitemtype.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZS4H_SALESORDER_GW_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA sepm_i_businessp_get_entityset TYPE zcl_zs4h_salesorder_gw_mpc=>tt_sepm_i_businesspartnertype.
 DATA sepm_i_salesorde_get_entityset TYPE zcl_zs4h_salesorder_gw_mpc=>tt_sepm_i_salesordertype.
 DATA sepm_i_salesor01_get_entityset TYPE zcl_zs4h_salesorder_gw_mpc=>tt_sepm_i_salesorderitemtype.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA sepm_i_businessp_update_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_businesspartnertype.
 DATA sepm_i_salesorde_update_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_salesordertype.
 DATA sepm_i_salesor01_update_entity TYPE zcl_zs4h_salesorder_gw_mpc=>ts_sepm_i_salesorderitemtype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_sepm_i_businesspartner_1 TYPE sepm_i_businesspartner ##NEEDED. " reference for where-used list
    TYPES ty_sepm_i_salesorder_2 TYPE sepm_i_salesorder ##NEEDED. " reference for where-used list
    TYPES ty_sepm_i_salesorderitem_3 TYPE sepm_i_salesorderitem ##NEEDED. " reference for where-used list
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20180829091519
               iv_uuid              = 'ZS4H_SALESORDER_GW'
